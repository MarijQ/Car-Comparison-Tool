    ...
    while True:
        ...
        for car_index in range(len(cars)):
            try:
                ...
                # Print the car details for debugging
                ...
                for div in details:
                    try:
                        ...
                        car_details[title] = detail
                    except Exception as e:
                        print(f"Error fetching detail: {e}")

                # Save the car data in a structured dictionary
                car_data = {
                    "link": link,
                    "car_name": car_name,
                    "price": price,
...
try:
    ...
    with open("scraped_car_data.json", "w") as f:
        json.dump(all_car_data, f, indent=4)
